...
let FlightSearch = require("./FlightSearch");
...
class FlightViewer extends React.Component {
  ...
  render() {
    let EachFlight, cheapestFlights, theErrorMessage, LoadingMessage, searchFlightsLoad;
    ...
    if (this.state.flightData) {
      ...
      const cheapestFlightsJson = theFlightParse.sort(function (a, b) {
